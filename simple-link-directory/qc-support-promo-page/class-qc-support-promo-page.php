...
if ( ! defined( 'qc_sld_img_url' ) )
    define('qc_sld_img_url', qc_sld_support_url . "/images" );
...
include_once qc_sld_support_path . '/qc-clr-recommendbot-support-plugin.php';
        ...
        <div class="qc-sld-support qcld-support-new-page">
            <div class="support-btn-main justify-content-center">
                <div class="col text-center">
                    ...
                    <div class="support-btn">
                        ...
                        <a style="width:282px" class="premium-support" href="<?php echo esc_url('https://www.quantumcloud.com/resources/kb-sections/simple-link-directory/'); ?>" target="_blank"><?php esc_html_e('Online KnowledgeBase', 'qc-clr'); ?></a>
                    </div>
                </div>
            ...
            <div class="qcld-plugins-lists">
                <div class="qcld-plugins-loading">
                    <img src="<?php echo esc_url(qc_sld_img_url); ?>/loading.gif" alt="loading">
                </div>
            </div>
        </div>
