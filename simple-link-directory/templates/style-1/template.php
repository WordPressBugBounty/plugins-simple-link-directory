...
if ( $list_query->have_posts() ) 
{
	...
	echo '<div class="qcld-main-container-style-1">';
	...
	if ( $sld_featured ) :
		...
		?>
		<div class="sld-featured-strip <?php echo esc_attr( $sld_featured['bg_class'] ); ?>" style="background: <?php echo esc_attr( $sld_featured['bg'] ); ?>;">
			...
			<?php foreach ( $sld_feat_chunks as $sld_feat_chunk ) : ?>
				<div class="qcopd-list-column style-1">
	...
	echo '<div class="qcopd-list-wrapper" '.wp_kses_post($sld_enable_rtl).'><div id="opd-list-holder" class="qc-grid qcopd-list-holder opd-list-holder-style-1">';
