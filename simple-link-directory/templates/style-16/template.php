...
wp_enqueue_style('sld-css-style-16' ); 
	...
	$qc_custom_js = " jQuery(document).ready(function($){
				...
				$('#opd-list-holder.qcsld-new-style-16 .qcopd-single-list ul').each(function() {
				  	var h = $(this).height();
				  	if( h > 280){
				  		//console.log( h );
...
if ( $list_query->have_posts() ) 
{
	...
	if ( $sld_featured ) :
		...
		?>
		<div class="qcld-main-container-style-16 sld-featured-strip sld-featured-strip-light">
			<?php qcopd_render_featured_heading( $sld_featured['total'] ); ?>
			<div class="qcsld-new-style-16 sld-featured-columns sld-feat-cols-<?php echo esc_attr( $sld_feat_cols ); ?>">
				<?php foreach ( $sld_feat_chunks as $sld_feat_chunk ) : ?>
				<div class="qcopd-list-column style-16 opd-column-<?php echo esc_attr( $sld_feat_cols ); ?>">
					<div class="qcopd-single-list">
						<ul start="<?php echo esc_attr( $sld_feat_count ); ?>">
