...
wp_enqueue_style('sld-css-style-2' ); 
	...
	if($sld_enable_rtl =='on'){
		$css = '.qcopd-list-wrapper .style-2 .ca-menu li {float:none;}';
...
if ( $list_query->have_posts() ) 
{
	...
	if ( $sld_featured ) :
		$sld_feat_count = 1;
		?>
		<div class="qcld-main-container-style-2 sld-featured-strip sld-featured-strip-light <?php echo esc_attr( $sld_featured['bg_class'] ); ?>" style="background: <?php echo esc_attr( $sld_featured['bg'] ); ?>;">
			<?php qcopd_render_featured_heading( $sld_featured['total'] ); ?>
			<div class="qcopd-list-column style-2 opd-column-<?php echo esc_attr( $column ); ?>">
				<ul class="ca-menu">
	...
	echo '<div class="qcld-main-container-style-2"><div class="qcopd-list-wrapper" '.wp_kses_post($sld_enable_rtl).'><div id="opd-list-holder" class="qc-grid qcopd-list-holder">';
