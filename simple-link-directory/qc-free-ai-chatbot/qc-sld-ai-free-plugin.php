...
add_action( 'wp_ajax_qcopd_sld_free_ai_function_first_sld_ajax', 'qcopd_sld_free_ai_function_first_sld_ajax' );
if( !function_exists('qcopd_sld_free_ai_function_first_sld_ajax') ){

    function qcopd_sld_free_ai_function_first_sld_ajax(){
        ...
        <div class="qcopd_sld_free_ai_recommended_plugins">
