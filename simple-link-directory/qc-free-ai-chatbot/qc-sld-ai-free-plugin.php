...
add_action( 'wp_ajax_qc_sld_free_ai_function_first_sld_ajax', 'qc_sld_free_ai_function_first_sld_ajax' );
if( !function_exists('qc_sld_free_ai_function_first_sld_ajax') ){

    function qc_sld_free_ai_function_first_sld_ajax(){
        ...
        <div class="qc_sld_free_ai_recommended_plugins">
