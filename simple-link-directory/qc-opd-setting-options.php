    ...
    <div class="sld-row">
      <div class="sld-col-md-9">
        <div class="sld-col-bg-color">
          <h3><?php esc_html_e('SLD Settings Page', 'qc-opd'); ?></h3>
          <div class="nav-tab-wrapper sld_nav_container">
            <a class="nav-tab sld_click_handle qcld_getting_started nav-tab-active"
              href="#getting_started"><?php esc_html_e('Getting Started', 'qc-opd'); ?></a>
            <a class="nav-tab sld_click_handle "
              href="#general_settings"><?php esc_html_e('General Settings', 'qc-opd'); ?></a>
            <a class="nav-tab sld_click_handle" href="#ai_settings"><?php esc_html_e('AI Settings', 'qc-opd'); ?></a>
            <a class="nav-tab sld_click_handle"
              href="#language_settings"><?php esc_html_e('Language Settings', 'qc-opd'); ?></a>
          ...
          <form method="post" action="options.php">
              ...
              <table class="form-table">
                <tr valign="top">
                  ...
                  <td><input type="checkbox" name="sld_enable_top_part" value="on" <?php echo (esc_attr(get_option('sld_enable_top_part')) == 'on' ? 'checked="checked"' : ''); ?> />
                    <i><?php esc_html_e('Top area includes Embed button (more options coming soon)', 'qc-opd'); ?></i>
                  </td>
                </tr>
                <tr valign="top">
                  ...
                  <td><input type="checkbox" name="sld_enable_search" value="on" <?php echo (esc_attr(get_option('sld_enable_search')) == 'on' ? 'checked="checked"' : ''); ?> />
                    <i><?php esc_html_e('Live search through directory items.', 'qc-opd'); ?></i>
                  </td>
                </tr>
                <tr valign="top">
                  ...
                  <td><input type="checkbox" name="sld_enable_upvote" value="on" <?php echo (esc_attr(get_option('sld_enable_upvote')) == 'on' ? 'checked="checked"' : ''); ?> />
                    <i><?php esc_html_e('Turn ON to visible Upvote feature for all templates.', 'qc-opd'); ?></i>
                  </td>
                </tr>
                <tr valign="top">
                  ...
                  <td><input type="checkbox" name="sld_add_new_button" value="<?php echo esc_attr('on'); ?>" <?php echo (esc_attr(get_option('sld_add_new_button')) == 'on' ? 'checked="checked"' : ''); ?> />
                    <i><?php esc_html_e('The button will link to a page of your choice where you can place a contact form or instructions to submit links to your directory. Links have to be manually added by the admin.', 'qc-opd'); ?></i>
                  </td>
                </tr>
                <tr valign="top">
                  ...
                  <td><input type="text" name="sld_add_item_link" size="100"
                    ...
                    <p>
                      <?php esc_html_e('Paste the full URL of a page that contains a contact form to submit link ', 'qc-opd'); ?>
                      (
                      <?php esc_html_e('Front end submission with monetization feature is available with the ', 'qc-opd'); ?>
                      <a href="<?php echo esc_url('https://www.quantumcloud.com/products/simple-link-directory/'); ?>"
                        target="_blank" rel="nofollow"><?php esc_html_e('Pro version', 'qc-opd'); ?></a> )
                    </p>
                  </td>
                </tr>
                <tr valign="top">
                  ...
                  <td><input type="checkbox" name="sld_enable_click_tracking" value="on" <?php echo (esc_attr(get_option('sld_enable_click_tracking')) == 'on' ? 'checked="checked"' : ''); ?> />
                    <i><?php esc_html_e('You need to have the analytics.js', 'qc-opd'); ?> [<a
                        href="https://support.google.com/analytics/answer/1008080#GA"
                        target="_blank"><?php esc_html_e('Analytics tracking code in every page of your site', 'qc-opd'); ?></a>].</i>
                  </td>
                </tr>
                <tr valign="top">
                  ...
                  <td><input type="text" name="sld_embed_credit_title" size="100"
                    ...
                    <i><?php esc_html_e('This text will be displayed below embedded list in other sites.', 'qc-opd'); ?></i>
                  </td>
                </tr>
                <tr valign="top">
                ...
                <tr valign="top">
                  ...
                  <td><input type="checkbox" name="sld_enable_scroll_to_top" value="on" <?php echo (esc_attr(get_option('sld_enable_scroll_to_top')) == 'on' ? 'checked="checked"' : ''); ?> />
                    <i><?php esc_html_e('Show Scroll to Top.', 'qc-opd'); ?></i>
                  </td>
                </tr>
                <tr valign="top">
                  ...
                  <td><input type="checkbox" name="sld_enable_rtl" value="on" <?php echo (esc_attr(get_option('sld_enable_rtl')) == 'on' ? 'checked="checked"' : ''); ?> />
                    <i><?php esc_html_e('If you make this option ON, then list items will be arranged in Right-to-Left direction.', 'qc-opd'); ?></i>
                  </td>
                </tr>
                <tr valign="top">
                  ...
                  <td><input type="checkbox" name="sld_enable_dark_mode" value="on" <?php echo (esc_attr(get_option('sld_enable_dark_mode')) == 'on' ? 'checked="checked"' : ''); ?> />
                    <i><?php esc_html_e('Enable this option to show Dark Mode for all themes', 'qc-opd'); ?></i>
                  </td>
                </tr>
              </table>
            </div>
              ...
              <table class="form-table">
                <tr valign="top">
                  ...
                  <td><input type="text" name="sld_lan_add_link" size="100"
                    ...
                    <i><?php esc_html_e('Change the language for Add New', 'qc-opd'); ?></i>
                  </td>
                </tr>
                <tr valign="top">
                  ...
                  <td><input type="text" name="sld_lan_share_list" size="100"
                    ...
                    <i><?php esc_html_e('Change the language for Share List', 'qc-opd'); ?></i>
                  </td>
                </tr>
                <tr valign="top">
                  ...
                  <td><input type="text" name="sld_lan_live_search" size="100"
                    ...
                    <i><?php esc_html_e('Change the language for Live Search Items', 'qc-opd'); ?></i>
                  </td>
                </tr>
                <tr valign="top">
                  ...
                  <td><input type="text" name="sld_no_results_found" size="100"
                    ...
                    <i><?php esc_html_e('Change the language for No Results Found for Your Search', 'qc-opd'); ?></i>
                  </td>
                </tr>
                <tr valign="top">
                  <th scope="row"> <?php esc_html_e('Enable Dark Mode', 'qc-opd'); ?></th>
                  <td><input type="text" name="sld_lan_enable_dark_mode" size="100"
                    ...
                    <i> <?php esc_html_e('Change the language for - Enable Dark Mode', 'qc-opd'); ?></i>
                  </td>
                </tr>
                <tr valign="top">
                  ...
                  <td><input type="text" name="sld_lan_dark_mode_on" size="100"
                    ...
                    <i> <?php esc_html_e('Change the language for - Dark Mode On', 'qc-opd'); ?></i>
                  </td>
                </tr>
                <tr valign="top">
                  ...
                  <td><input type="text" name="sld_lan_light_mode_on" size="100"
                    ...
                    <i> <?php esc_html_e('Change the language for - Light Mode On', 'qc-opd'); ?></i>
                  </td>
                </tr>
              </table>
            </div>
            <div id="custom_css" style="display:none" class="qcld-tabs-custom">
              <table class="form-table">
                <tr valign="top">
                  <th scope="row">
                    <?php esc_html_e('Custom CSS (Use *!important* flag if the changes does not take place)', 'qc-opd'); ?>
                  </th>
                  <td><textarea id="sld_custom_style" name="sld_custom_style" rows="10"
                    ...
                    <i style="display:block;"><?php esc_html_e('Write your custom CSS here. Please do not use', 'qc-opd'); ?>
                      <b><?php esc_html_e('style', 'qc-opd'); ?></b>
                      <?php esc_html_e('tag in this textarea.', 'qc-opd'); ?></i>
                  </td>
                </tr>
              </table>
            </div>
              ...
              <table class="form-table">
                <tr valign="top">
                  ...
                  <td><textarea id="sld_custom_js" name="sld_custom_js" rows="10"
                    ...
                    <i style="display:block;"><?php esc_html_e('Write your custom JS here. Please do not use', 'qc-opd'); ?>
                      <b><?php esc_html_e('script', 'qc-opd'); ?></b>
                      <?php esc_html_e('tag in this textarea.', 'qc-opd'); ?></i>
                  </td>
                </tr>
              </table>
            ...
            <div id="ai_settings" style="display:none" class="qcld-tabs-custom">
              <table class="form-table">
                <tr valign="top">
                  <th scope="row"><?php esc_html_e('Select Active AI Provider', 'qc-opd'); ?></th>
                  <td>
                    ...
                    <div class="sld-ai-provider-toggle-group">
                      <label class="sld-ai-provider-card <?php echo ($selected_provider === 'none') ? 'active' : ''; ?>">
                        ...
                        <span class="sld-ai-provider-title"><?php esc_html_e('Disable AI', 'qc-opd'); ?></span>
                      </label>
                      <label
                        ...
                        <span class="sld-ai-provider-title"><?php esc_html_e('OpenAI', 'qc-opd'); ?></span>
                      </label>
                      <label
                        ...
                        <span class="sld-ai-provider-title"><?php esc_html_e('Google Gemini', 'qc-opd'); ?></span>
                      </label>
                      <label
                        ...
                        <span class="sld-ai-provider-title"><?php esc_html_e('OpenRouter', 'qc-opd'); ?></span>
                      </label>
                    </div>
                    <p class="description" style="margin-top: 10px;">
                      <?php esc_html_e('Choose which AI provider to enable for the directory features. Selecting "Disable AI" turns off all AI functionalities.', 'qc-opd'); ?>
                    </p>
                  </td>
                </tr>
                <tr valign="top">
                  <th scope="row"><?php esc_html_e('Auto Save Generated Items', 'qc-opd'); ?></th>
                  <td>
                    ...
                    <p class="description">
                      <?php esc_html_e('If enabled, directory posts will be automatically saved/updated immediately after the elements are successfully generated by the AI.', 'qc-opd'); ?>
                    </p>
                  </td>
                </tr>
                <tr valign="top" class="sld-openai-settings-row">
                  <th scope="row" colspan="2"
                    ...
                    <?php esc_html_e('OpenAI Integration Settings', 'qc-opd'); ?>
                  </th>
                </tr>
                <tr valign="top" class="sld-openai-settings-row">
                  <th scope="row"><?php esc_html_e('OpenAI API Key', 'qc-opd'); ?></th>
                  <td>
                    <input type="password" name="sld_openai_api_key" id="sld_openai_api_key" size="80"
                      ...
                      placeholder="<?php esc_attr_e('sk-...', 'qc-opd'); ?>" style="vertical-align: middle;" />
                    <button type="button" class="button button-secondary" id="sld_test_openai_btn"
                      style="vertical-align: middle; margin-left: 5px;"><?php esc_html_e('Test Connection', 'qc-opd'); ?></button>
                    <span id="sld_openai_test_status"
                      style="margin-left: 10px; font-weight: bold; vertical-align: middle;"></span>
                    <p class="description">
                      <?php esc_html_e('Enter your OpenAI API key for AI generation features.', 'qc-opd'); ?>
                    </p>
                  </td>
                </tr>
                <tr valign="top" class="sld-openai-settings-row">
                  <th scope="row"><?php esc_html_e('OpenAI Model', 'qc-opd'); ?></th>
                  <td>
                ...
                <tr valign="top" class="sld-openai-settings-row">
                  <th scope="row"><?php esc_html_e('OpenAI Temperature', 'qc-opd'); ?></th>
                  <td>
                    ...
                    <p class="description">
                      <?php esc_html_e('Controls randomness: Higher values like 1.2 will make the output more random, while lower values like 0.2 will make it more focused and deterministic. Range: 0.0 to 2.0 (Default: 1.0). Note: Temperature is ignored for reasoning models (o1/o3 series).', 'qc-opd'); ?>
                    </p>
                  </td>
                </tr>
                ...
                <tr valign="top" class="sld-gemini-settings-row">
                  <th scope="row" colspan="2"
                    ...
                    <?php esc_html_e('Google Gemini Integration Settings', 'qc-opd'); ?>
                  </th>
                </tr>
                <tr valign="top" class="sld-gemini-settings-row">
                  <th scope="row"><?php esc_html_e('Gemini API Key', 'qc-opd'); ?></th>
                  <td>
                    ...
                    <span id="sld_gemini_test_status"
                      style="margin-left: 10px; font-weight: bold; vertical-align: middle;"></span>
                    <p class="description"><?php esc_html_e('Enter your Google Gemini API key.', 'qc-opd'); ?></p>
                  </td>
                </tr>
                <tr valign="top" class="sld-gemini-settings-row">
                  <th scope="row"><?php esc_html_e('Gemini Model', 'qc-opd'); ?></th>
                  <td>
                ...
                <tr valign="top" class="sld-gemini-settings-row">
                  <th scope="row"><?php esc_html_e('Gemini Temperature', 'qc-opd'); ?></th>
                  <td>
                    ...
                    <p class="description">
                      <?php esc_html_e('Controls randomness: Higher values like 1.2 will make the output more random, while lower values like 0.2 will make it more focused and deterministic. Range: 0.0 to 2.0 (Default: 1.0).', 'qc-opd'); ?>
                    </p>
                  </td>
                </tr>
                <tr valign="top" class="sld-openrouter-settings-row">
                  <th scope="row" colspan="2"
                    style="background: #f1f5f9; padding: 10px 15px; font-weight: bold; font-size: 16px; border-radius: 8px; margin-top: 20px;">
                    <?php esc_html_e('OpenRouter Integration Settings', 'qc-opd'); ?>
                  </th>
                </tr>
                <tr valign="top" class="sld-openrouter-settings-row">
                  <th scope="row"><?php esc_html_e('OpenRouter API Key', 'qc-opd'); ?></th>
                  <td>
                    ...
                    <span id="sld_openrouter_test_status"
                      style="margin-left: 10px; font-weight: bold; vertical-align: middle;"></span>
                    <p class="description">
                      <?php esc_html_e('Enter your OpenRouter API Key. You can get one from openrouter.ai.', 'qc-opd'); ?>
                    </p>
                  </td>
                </tr>
                <tr valign="top" class="sld-openrouter-settings-row">
                  <th scope="row"><?php esc_html_e('OpenRouter Model', 'qc-opd'); ?></th>
                  <td>
                ...
                <tr valign="top" class="sld-openrouter-settings-row">
                  <th scope="row"><?php esc_html_e('OpenRouter Temperature', 'qc-opd'); ?></th>
                  <td>
                    ...
                    <p class="description">
                      <?php esc_html_e('Controls randomness: Range 0.0 to 2.0 (Default: 1.0).', 'qc-opd'); ?></p>
                  </td>
                </tr>
                <tr valign="top" class="sld-ai-general-settings-row">
                  <th scope="row" colspan="2"
                    style="background: #f1f5f9; padding: 10px 15px; font-weight: bold; font-size: 16px; border-radius: 8px; margin-top: 20px;">
                    <?php esc_html_e('AI Prompt Settings', 'qc-opd'); ?>
                  </th>
                </tr>
                <tr valign="top" class="sld-ai-general-settings-row">
                  <th scope="row"><?php esc_html_e('Custom Prompt Instruction', 'qc-opd'); ?></th>
                  <td>
                    <?php
                    ...
                    <div style="margin-top: 8px; margin-bottom: 10px;">
                      <button type="button" class="button button-secondary"
                        id="sld_reset_ai_prompt_btn"><?php esc_html_e('Reset to Default', 'qc-opd'); ?></button>
                      <span id="sld_reset_ai_prompt_status"
                        style="margin-left: 10px; font-weight: bold; vertical-align: middle;"></span>
                    </div>
                    <p class="description sld-alert-warning">
                      <?php esc_html_e('You can customize the prompt instructions sent to the AI model. Be sure to include the placeholders {count} and {prompt} so they can be replaced by the user\'s inputs dynamically. Also, keep the general format of the prompt as is. Do not modify if you are uncertain.', 'qc-opd'); ?>
                    </p>
                  </td>
                </tr>
              </table>
                        ...
                        <div id="post-body" class="metabox-holder columns-2">
                          <div id="post-body-content" style="position: relative;">
                            ...
                            <h3 class="qcld_short_genarator_scroll_wrap">
                              <?php esc_html_e('Shortcode Generator', 'qc-opd'); ?>
                            </h3>
                            <p>
                              <?php esc_html_e('We encourage you to use the ShortCode generator found in the toolbar of your page/post editor in visual mode.', 'qc-opd'); ?>
                            </p>
                            <img src="<?php echo esc_url(QCOPD_IMG_URL); ?>/classic.jpg" alt="shortcode generator" />
                            <h3><?php esc_html_e('See sample below for where to find it for Gutenberg.', 'qc-opd'); ?>
                            </h3>
                            ...
                            <div class="qcld-sld-shortcode-example">
                              ...
                              <p>
                                <strong><?php esc_html_e('You can use our given SHORTCODE GENERATOR to generate and insert shortcode easily, titled as "SLD" with WordPress content editor.', 'qc-opd'); ?></strong>
                              </p>
                              <p> <strong><u><?php esc_html_e('For all the lists:', 'qc-opd'); ?></u></strong> <br>
                                <span
                                  class="qcld-sld-code-highlight"><?php esc_html_e('[qcopd-directory mode="all" column="2" style="simple" orderby="date" order="DESC" enable_embedding="false"]', 'qc-opd'); ?></span>
                              </p>

                              <p> <strong><u><?php esc_html_e('For only a single list:', 'qc-opd'); ?></u></strong> <br>
                                <span class="qcld-sld-code-highlight">
                                  <?php esc_html_e('[qcopd-directory mode="one" list_id="75"]', 'qc-opd'); ?></span>
                              </p>
                              <p><strong><u><?php esc_html_e('Available Parameters:', 'qc-opd'); ?></u></strong> <br>
                              </p>
                              <p> <strong><?php esc_html_e('1. mode', 'qc-opd'); ?></strong> <br>
                                <span
                                  class="qcld-sld-code-highlight"><?php esc_html_e('[Value for this option can be set as "one" or "all".]', 'qc-opd'); ?></span>
                              </p>
                              ...
                              <p> <strong><?php esc_html_e('3. style', 'qc-opd'); ?></strong> <br>
                                <?php esc_html_e('Avaialble values: "simple", "style-1", "style-2", "style-3", "style-4", "style-5", "style-16".', 'qc-opd'); ?>
                                <br>
                                <strong
                                  style="color: red; padding: 10px 10px; display: inline-block; border: 1px solid; border-radius: 6px; margin: 5px 0 5px 0;">
                                  <?php esc_html_e('Only 6 templates are available in the free version. For more styles or templates, please purchase the', 'qc-opd'); ?>
                                  <a href="<?php echo esc_url('https://www.quantumcloud.com/products/simple-link-directory/'); ?>"
                                    target="_blank" target="_blank"
                                    rel="nofollow"><?php esc_html_e('premium version', 'qc-opd'); ?></a>. </strong>
                              </p>
                              <p> <strong><?php esc_html_e('4. orderby', 'qc-opd'); ?></strong> <br>
                                <?php esc_html_e("Compatible order by values: 'ID', 'author', 'title', 'name', 'type', 'date', 'modified', 'rand' and 'menu_order'.", 'qc-opd'); ?>
                              </p>
                              <p> <strong><?php esc_html_e('5. order', 'qc-opd'); ?></strong> <br>
                                <?php esc_html_e('Value for this option can be set as "ASC" for Ascending or "DESC" for Descending order.', 'qc-opd'); ?>
                              </p>
                              <p> <strong><?php esc_html_e('6. item_orderby', 'qc-opd'); ?></strong> <br>
                                <?php esc_html_e('Value for this option are "title", "upvotes", "timestamp" that will be set as "ASC" & others will be "DESC" order.', 'qc-opd'); ?>
                              </p>
                              <p> <strong><?php esc_html_e('7. list_id', 'qc-opd'); ?></strong> <br>
                                <?php esc_html_e('Only applicable if you want to display a single list [not all]. You can provide specific list id here as a value. You can also get ready shortcode for a single list under "Manage List Items" menu.', 'qc-opd'); ?>
                              </p>
                              <p> <strong><?php esc_html_e('8. enable_embedding', 'qc-opd'); ?></strong> <br>
                                <?php esc_html_e('Allow visitors to embed list in other sites. Supported values - "true", "false".', 'qc-opd'); ?>
                                <br>
                                <?php esc_html_e('Example: enable_embedding="true"', 'qc-opd'); ?>
                              </p>
                              <p> <strong><?php esc_html_e('8. upvote', 'qc-opd'); ?></strong> <br>
                                <?php esc_html_e('Allow visitors to list item. Supported values - "on", "off".', 'qc-opd'); ?>
                                <br>
                                <?php esc_html_e('Example: upvote="on"', 'qc-opd'); ?>
                              </p>
                              <p> <strong><?php esc_html_e('9. style-16 image show', 'qc-opd'); ?></strong> <br>
                                <?php esc_html_e(' Add the shortcode parameter enable_image="true" to show images with style-16', 'qc-opd'); ?>
                                <br>
                                <?php esc_html_e('Example: enable_image="true"', 'qc-opd'); ?>
                              </p>
                              <p> <strong><?php esc_html_e('10. Search', 'qc-opd'); ?></strong> <br>
                                <?php esc_html_e(' Add the shortcode parameter search="true" to show Live Search', 'qc-opd'); ?>
                                <br>
                                <?php esc_html_e('Example: search="true"', 'qc-opd'); ?>
                              </p>
                              <p> <strong><?php esc_html_e('11. dark_mode', 'qc-opd'); ?></strong> <br>
                                <?php esc_html_e('You can use this value to use the dark_mode of SLD templates. Available values for this option "on", "off".', 'qc-opd'); ?>
                              </p>
                            ...
                            <div class="qcld_sld_tabs">
                              ...
                              <div class="qcld_sld_tab">
                                ...
                                <label class="qcld_sld_tab-label"
                                  for="qcld_sld_tab_2"><?php esc_html_e('= The sub title is not showing =', 'qc-opd'); ?></label>
                                <div class="qcld_sld_tab-content">
                                  <p>
                                    <?php esc_html_e('The default template does not show subtitles. Use style-1 from the shortcode generator to display subtitles.', 'qc-opd'); ?>
                                  </p>
                                </div>
                              </div>
                              <div class="qcld_sld_tab">
                                ...
                                <label class="qcld_sld_tab-label" for="qcld_sld_tab_3">
                                  <?php esc_html_e('= Does the free version have filter buttons? =', 'qc-opd'); ?></label>
                                <div class="qcld_sld_tab-content">
                                  <p>
                                    <?php esc_html_e('No. It is a pro version feature at the moment. But in the future, we have plans to make it available in the free version as well.', 'qc-opd'); ?>
                                  </p>
                                </div>
                              </div>
                              <div class="qcld_sld_tab">
                                ...
                                <label class="qcld_sld_tab-label"
                                  for="qcld_sld_tab_4"><?php esc_html_e('= I cannot have more than 1 columns =', 'qc-opd'); ?></label>
                                <div class="qcld_sld_tab-content">
                                  <p>
                                    <?php esc_html_e('To display more than one column, you need to create multiple Lists and choose to Show All Lists from the shortcode generator. A single list will always show in a single column.', 'qc-opd'); ?>
                                  </p>
                                </div>
                              </div>
                              <div class="qcld_sld_tab">
                                ...
                                <label class="qcld_sld_tab-label" for="qcld_sld_tab_5">
                                  <?php esc_html_e('= I’m having trouble grasping the use of categories. It seems like and that they can only be assigned to a list rather than a specific link. =', 'qc-opd'); ?></label>
                                <div class="qcld_sld_tab-content">
                                  <p>
                              ...
                              <div class="qcld_sld_tab">
                                ...
                                <label class="qcld_sld_tab-label"
                                  for="qcld_sld_tab_6"><?php esc_html_e('= Do you have pagination or load more items? I have thousands of links=', 'qc-opd'); ?></label>
                                <div class="qcld_sld_tab-content">
                                  <p>
                                    <?php esc_html_e('Items in lists can be paginated in the pro version. This option is available in the shortcode generator. But you can also add the parameters manually.', 'qc-opd'); ?>
                                  </p>

                                  <p>
                                    <?php esc_html_e('Values: “true”, “false”. This option will allow you to paginate list items. It will break the list page wise. Example: paginate_items=“true”. You also need to add the parameter per_page. This option indicates the number of items per page. Default is “5”. paginate_items=“true” is required to get this parameter working. Example: per_page=“5”', 'qc-opd'); ?>
                                  </p>

                                  <p>
                                    <?php esc_html_e('Lists themselves cannot be paginated as the main concept of SLD is to be a Simple, One Page Directory.', 'qc-opd'); ?>
                                  </p>
                                </div>
                              </div>
                              <div class="qcld_sld_tab">
                                ...
                                <label class="qcld_sld_tab-label"
                                  for="qcld_sld_tab_7"><?php esc_html_e('= I have a list to import but it does not work and there is no message saying why my import does not work. =', 'qc-opd'); ?></label>
                                <div class="qcld_sld_tab-content">
                                  <p>
                                    <?php esc_html_e('The most common reason for failed import is encoding. The CSV file itself and characters in it must be in utf-8 format. Please check your CSV file for any unusual/non-utf-8 characters. If the problem persists, please email us the CSV file.', 'qc-opd'); ?>
                                  </p>
                                </div>
                              </div>
                              <div class="qcld_sld_tab">
                                ...
                                <label class="qcld_sld_tab-label"
                                  for="qcld_sld_tab_8"><?php esc_html_e('= I have some blank pages that are crawled by Google! How to avoid them? =', 'qc-opd'); ?></label>
                                <div class="qcld_sld_tab-content">
                                  <p>
                                    <?php esc_html_e('Like many, if not most, WordPress plugins SLD uses custom posts and WordPress creates slug URLs even though they are not being used by SLD at the moment. We are working on making use of them.', 'qc-opd'); ?>
                                  </p>
                                  <p>
                                    <?php esc_html_e('But rest assured they are not harmful. They are generally not linked from anywhere and not indexed by Google. The only exception is if you have an XML sitemap generator that automatically scans and generates Links to these slug URLs. Yoast SEO plugin does that. You can exclude those slugs from xml sitemap. Go to Yoast->XML Sitemap->Post Types tag and select Manage List Items (sld) to Not in sitemap – then Save.', 'qc-opd'); ?>
                                  </p>
                                </div>
                              </div>
                              <div class="qcld_sld_tab">
                                ...
                                <label class="qcld_sld_tab-label"
                                  for="qcld_sld_tab_9"><?php esc_html_e('= How can I upgrade from free version of SLD to Pro version? =', 'qc-opd'); ?></label>
                                <div class="qcld_sld_tab-content">
                                  <p>
                                    <?php esc_html_e('1. Download the latest pro version of the plugin from website', 'qc-opd'); ?>
                                  </p>
                                  <p>
                                    <?php esc_html_e('2. Log in to your WordPress admin area and go to the Plugins management page.', 'qc-opd'); ?>
                                  </p>
                                  <p>
                                    <?php esc_html_e('3. Deactivate and Delete the old version of the plugin (don’t worry – your data is safe)', 'qc-opd'); ?>
                                  </p>
                                  <p>
                                    <?php esc_html_e('4. Upload and Activate the latest pro version of the plugin', 'qc-opd'); ?>
                                  </p>
                              ...
                              <div class="qcld_sld_tab">
                                ...
                                <label class="qcld_sld_tab-label"
                                  for="qcld_sld_tab_10"><?php esc_html_e('= I have setup List Categories and Lists and neither is showing on home page. Did I install correctly? =', 'qc-opd'); ?></label>
                                <div class="qcld_sld_tab-content">
                                  <p>
                                    <?php esc_html_e('You have to put the short code on the WordPress oage or post page where you want to show the List/s. There is a Shortcode generator in your page or post visual editor. Use that to create shortcode and insert to your page, where you want to display the lists, easily.', 'qc-opd'); ?>
                                  </p>
                                </div>
                              </div>
                              <div class="qcld_sld_tab">
                                ...
                                <label class="qcld_sld_tab-label"
                                  for="qcld_sld_tab_11"><?php esc_html_e('= Is SLD mobile friendly? Does it function well on cells and tablets? =', 'qc-opd'); ?></label>
                                <div class="qcld_sld_tab-content">
                                  <p>
                                    <?php esc_html_e('Yes, all templates are mobile device friendly and Responsive.', 'qc-opd'); ?>
                                  </p>
                                </div>
                              </div>
      ...
      <!-- Sidebar -->
      <?php qcld_sld_help_render_sidebar(); ?>
    </div>
  </div>
 ...
 */
function sld_get_openai_models()
{
 ...
 */
function sld_get_gemini_models()
{
...
add_action('update_option_sld_openai_api_key', 'sld_clear_openai_models_transient');
function sld_clear_openai_models_transient()
{
  delete_transient('sld_openai_models_list');
}

add_action('update_option_sld_gemini_api_key', 'sld_clear_gemini_models_transient');
function sld_clear_gemini_models_transient()
{
 ...
 */
function sld_get_openrouter_models()
{
...
add_action('update_option_sld_openrouter_api_key', 'sld_clear_openrouter_models_transient');
function sld_clear_openrouter_models_transient()
{
